      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* AI Status */}
            <div className="flex items-center space-x-2 px-3 py-2 bg-black/30 rounded-lg border border-white/10">
              <HiPlayCircle className={cn('w-4 h-4', {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-black/30 rounded-xl p-6 backdrop-blur-sm border border-white/10">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="bg-red-500/20 text-red-400 px-2 py-1 rounded-lg text-sm font-medium">
          ...
          <div className="bg-black/30 rounded-xl p-6 backdrop-blur-sm border border-white/10">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="bg-purple-500/20 text-purple-400 px-2 py-1 rounded-lg text-sm font-medium">
              ...
              {anomalyPatterns.map((pattern) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="text-gray-500">
                      Components: {pattern.affectedComponents.length}
                    </span>
                  </div>
                </motion.div>
              ))}
