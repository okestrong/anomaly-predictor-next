...
export default function RiskMeter({ score }: RiskMeterProps) {
   ...
   return (
      <div className="relative w-full h-28">
         <svg className="absolute inset-y-0 left-[98px] w-48 h-full" viewBox="0 0 200 100">
            {/* Background arc */}
            ...
            />
            {/* Needle */}
            <motion.line x1="100" y1="80" x2={x2} y2={y2} stroke="#00d4ff" strokeWidth="1.5" />
         ...
         <div className="absolute bottom-0 left-0 right-0 text-center">
            <div className="text-2xl -translate-y-8 font-bold text-ai-circuit">{score.toFixed(1)}%</div>
