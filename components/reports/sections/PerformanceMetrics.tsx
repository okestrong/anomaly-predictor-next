      ...
      <div className="space-y-8 print:text-black">
         ...
         <section>
            ...
            {iops.poolTrends && (
               <Card variant="glass" className="p-4 mb-6 print:border print:border-gray-300 print:bg-white print:p-3 overflow-hidden">
                  <h3 className="text-base font-medium mb-2 text-white print:text-black">Pool IOPS Trends</h3>
                  <div data-chart="iops-trend" className="w-full overflow-hidden">
         ...
         <section className="page-break-before">
            ...
            {latency.distribution && (
               <Card variant="glass" className="p-4 mb-6 print:border print:border-gray-300 print:bg-white print:p-3 overflow-hidden">
                  <h3 className="text-base font-medium mb-2 text-white print:text-black">Latency Distribution</h3>
                  <div data-chart="latency-distribution" className="w-full overflow-hidden">
         ...
         <section>
            ...
            {throughput.trends && (
               <Card variant="glass" className="p-4 mb-6 print:border print:border-gray-300 print:bg-white print:p-3 overflow-hidden">
                  <h3 className="text-base font-medium mb-2 text-white print:text-black">Throughput Trends</h3>
                  <div data-chart="throughput-trend" className="w-full overflow-hidden">
