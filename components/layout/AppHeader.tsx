...
*/
   ...
   const toggleTheme = useCallback(() => {
      console.log('##### before isDark=', isDark);
      setIsDark(!isDark);
   }, [isDark]);
         ...
         <div className="w-full px-6 relative">
            <div className="flex items-center justify-between h-16">
                        ...
                        >
                           ...
                           >
                              ...
                              {menu.submenu && menu.submenu.length > 0 && (
                                 <ChevronDownIcon className={cn('w-3 h-3 transition-transform duration-200', { 'rotate-180': activeMenu === menu.id })} />
                              )}
                           </button>
               ...
               <div className="flex items-center space-x-4">
                  ...
                  {/* Notification center */}
                  <div className="relative">
                     <Button variant="secondary" size="sm" onClick={toggleNotifications} className="relative">
                  ...
                  <div className="relative" ref={userMenuRef}>
                     <Button variant="secondary" size="sm" onClick={toggleUserMenu}>
